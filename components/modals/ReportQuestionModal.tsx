    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Report an Issue">
            <div className="mb-4">
                ...
                <p className="font-semibold text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-700 p-2 rounded-md">{question.question}</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label className="block text-sm font-medium mb-1 dark:text-gray-300">Reason for reporting</label>
                    <select
                        value={reason}
                        onChange={(e) => setReason(e.target.value)}
                        className="w-full p-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-indigo-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        required
                    >
                ...
                <div>
                    <label htmlFor="comments" className="block text-sm font-medium mb-1 dark:text-gray-300">
                    ...
                    <textarea
                        ...
                        rows={4}
                        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        placeholder="Please provide any extra details here."
                    />
                </div>
                <div className="flex justify-end gap-3 pt-2">
                     <button type="button" onClick={onClose} className="px-4 py-2 bg-gray-200 text-gray-800 font-semibold rounded-lg hover:bg-gray-300 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
                        Cancel
                    </button>
