...
const SolutionScreen: React.FC<SolutionScreenProps> = ({ test, userAnswers, onBackToResults, onBackToHome }) => {
                    ...
                    {filteredIndices.length > 0 && currentQuestion ? (
                        <>
                            <p className="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6 leading-relaxed">
                                <span className="text-gray-500 dark:text-gray-400">{currentSolutionIndex + 1}. </span>{currentQuestion.question}
                            </p>
