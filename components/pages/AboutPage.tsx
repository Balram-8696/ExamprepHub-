                    ...
                    <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                        <div className="relative text-center">
                            <dt>
                                ...
                                <p className="mt-16 text-lg leading-6 font-medium text-gray-900 dark:text-gray-200">Comprehensive Test Series</p>
                            </dt>
                        ...
                        <div className="relative text-center">
                            <dt>
                                ...
                                <p className="mt-16 text-lg leading-6 font-medium text-gray-900 dark:text-gray-200">Instant Performance Analysis</p>
                            </dt>
                            <dd className="mt-2 text-base text-gray-500 dark:text-gray-400">
                        ...
                        <div className="relative text-center">
                            <dt>
                                ...
                                <p className="mt-16 text-lg leading-6 font-medium text-gray-900 dark:text-gray-200">Community of Learners</p>
                            </dt>
                            <dd className="mt-2 text-base text-gray-500 dark:text-gray-400">
