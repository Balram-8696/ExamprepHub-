                            ...
                            <tr key={test.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <button onClick={() => onEditTest(test.id)} className="text-indigo-600 hover:text-indigo-900"><Pencil size={18} /></button>
                                        <button onClick={() => handleDeleteClick(test)} className="text-red-600 hover:text-red-900"><Trash2 size={18} /></button>
                                    </div>
                                </td>
                            </tr>
                        ))}
